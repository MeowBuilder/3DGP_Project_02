...
ID3D12RootSignature* CStartScene::CreateGraphicsRootSignature(ID3D12Device* pd3dDevice)
{
...
ID3D12RootSignature* CStartScene::GetGraphicsRootSignature()
{
...
void CStartScene::ReleaseUploadBuffers()
{
...
bool CStartScene::OnProcessingMouseMessage(HWND hWnd, UINT nMessageID, WPARAM wParam, LPARAM
	lParam)
{
	return(false);
}

bool CStartScene::OnProcessingKeyboardMessage(HWND hWnd, UINT nMessageID, WPARAM wParam,
	LPARAM lParam)
{
	return(false);
}
